...
OUTPUT_DIR = PROJECT_DIR / "reproduced" / "results"
FIGURE_DIR = OUTPUT_DIR / "30_final_figures"

OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
FIGURE_DIR.mkdir(parents=True, exist_ok=True)

PANEL_FILE = PROJECT_DIR / "data" / "processed" / "etf_monthly_architecture_panel.csv"
PERSISTENT_FILE = PROJECT_DIR / "data" / "processed" / "persistent_architecture_scores.csv"
